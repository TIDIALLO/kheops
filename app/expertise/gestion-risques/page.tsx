...
import { Shield, AlertTriangle, LineChart, FileCheck } from 'lucide-react'
      ...
      <div className="relative z-10 py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-12 bg-white/80 backdrop-blur-sm p-8 rounded-2xl shadow-lg">
            ...
            >
              Anticipez et maîtrisez les risques pour sécuriser vos projets
            </motion.p>
          </div>
          ...
          >
            ...
            <div className="absolute bottom-0 left-0 right-0 p-8 text-white">
              <h2 className="text-3xl font-bold mb-2">Sécurité et Performance</h2>
              <p className="text-lg">Une approche proactive de la gestion des risques</p>
            </div>
          </motion.div>
            ...
            {[
              {
                ...
                description: "Identification et prévention des risques"
              },
              {
                icon: AlertTriangle,
                title: "Analyse des Menaces",
                description: "Évaluation approfondie des vulnérabilités"
              },
              {
                icon: LineChart,
                title: "Suivi Continu",
              ...
              },
              {
                ...
                description: "Stratégies de mitigation sur mesure"
              }
            ].map((feature, index) => (
              <motion.div
                key={index}
          ...
          >
            <h2 className="text-4xl font-bold mb-4">Sécurisez votre avenir</h2>
